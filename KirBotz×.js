...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Suport Heri Hermawan',
			error: {
...
*──────" 𝕭𝖔𝖙 𝕴𝖓𝖋𝖔 "──────*
 👤OWNER : *https://wa.me/6285643255717*
...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "fileName": "Heri•bot Bot WhatsApp",
  ...
  }}, MessageType.buttonsMessage,{ quoted: ftrol, sendEphemeral: true, contextInfo:{"forwardingScore":999,"isForwarded":true, "externalAdReply":{"title": `Hai Kak ${pushname}`, "body": `YT : Heri•Bot×`, mediaType: 2, "thumbnailUrl": "https://telegra.ph/file/daa8e7a3280efa76acce1.jpg","previewType": "VIDEO","mediaUrl": `https://youtu.be/BH4ipz4O-sQ/`}}})
  break
case 'allmenu':
...
case 'waktu':
            ...
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6287705048235@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `©Heri•Hermawan`, 'jpegThumbnail': fs.readFileSync('./AkIrTid/kirbotz.jpg')}}}})
            } else
if ((args[0]) == '2bulan'){
            pay =`${harga2bulan}`            
...
case 'randombokep':
              ...
              kirbotz.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftrol, caption: `NI BOKEP SAYA DAPAT DARI *©Heri•Bot* DOSA TANGGUNG SENDIRI🗿`})
              break
case 'play':
...
tekss = `Ini Bang Jan Lupa Suport Heri•Hermawan×`
trans = `KirTod`
but = [
...
break
			...
			case 'transformer': 
					...
					break
               case 'googletxt':
                  if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Heri•Hermawan|chan|kawai`)
             makell = args.join(" ")
             ll1 = makell.split("|")[0];
             ll2 = makell.split("|")[1];
             ll3 = makell.split("|")[0];
...
case 'blackpink':
                ...
                case 'thunder':
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=DashBot&text=${ini_txt}`).then((gambar) => {
                        kirbotz.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `卄乇尺丨•乃ㄖㄒ×`, quoted : ftrol})
                    })
                    break
case 'tiktok':
                case 'arcade8bit':
...
`, text, { thumbnail: Heri•Hermawan, sendEphemeral: true, quoted: fdoc, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📄 𝕊ℂℝ𝕀ℙ𝕋 📄",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./AkIrTid/kirbotz.jpg'),sourceUrl:"https://youtube.com/channel/UC7NslQroUqQYzo2wDFBOUMg"}}} )
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
kirbotz.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Suport Heri•Hermawan×' })
fs.unlinkSync(ran)
})
break
case 'gk':
...
`, text, { thumbnail: krbtz, sendEphemeral: true, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Suport Heri•Hermawan×",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./AkIrTid/kirbotz.jpg'),sourceUrl:"https://chat.whatsapp.com/CswK4kvQD1u7SfSmsYfMHZ"}}} )
...
case 'bc':
      case 'broadcast':
             ...
             if (args.length < 1) return reply('teks nya mana oy?')
